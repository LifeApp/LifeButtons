...
public class RelationshipMaintenance extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_relationship_maintenance);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.relationship_maintenance, menu);
		return true;
	}
	...
	public class CollectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				return getString(R.string.spider_map).toUpperCase(l);
			case 1:
				return getString(R.string.social_rating).toUpperCase(l);
	...
	public static class DummySectionFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			{
			case 0:
				tabs = R.layout.frag_spider_map;
				break;
			case 1:
				tabs = R.layout.frag_social_rating;
				break;
			}
