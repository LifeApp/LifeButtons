...
public class DosAndDonts extends FragmentActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.dos_and_donts, menu);
		return true;
	}
	...
	public class CollectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				return getString(R.string.asking_questions).toUpperCase(l);
			case 1:
				return getString(R.string.active_listening).toUpperCase(l);
			case 2:
				return getString(R.string.volume).toUpperCase(l);
			case 3:
				return getString(R.string.content).toUpperCase(l);				
			}
			return null;
		}
	}
	...
	public static class DummySectionFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			{
			case 0:
				tabs = R.layout.frag_do_dont_asking_questions;
				break;
			case 1:
				tabs = R.layout.frag_do_dont_active_listening;
				break;
			case 2:
				tabs = R.layout.frag_do_dont_volume;
				break;
			case 3:
				tabs = R.layout.frag_do_dont_content;
				break;
			}
