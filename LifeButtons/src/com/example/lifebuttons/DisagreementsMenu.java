...
public class DisagreementsMenu extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_disagreements_menu);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.disagreements_menu, menu);
		return true;
	}
	...
	public static class DummySectionFragment extends Fragment {
		 ...
		 * fragment.
		 */
		public static final String ARG_OBJECT = "section_number";
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			{
			case 0:
				tabs = R.layout.frag_disagreements_family;
				break;
			case 1:
				tabs = R.layout.frag_disagreements_friends;
				break;
			case 2:
				tabs = R.layout.frag_disagreements_professionals;
				break;
			case 3:
				tabs = R.layout.frag_disagreements_new_people;
				break;
			}
